...
> **Historical v4.4-LT research note.** This probe does not validate the
> Profile-1 ExactReplay launch or the future succinct-proof epochs. See the
> canonical [MatMul v4.7 transition roadmap](../../doc/btx-matmul-v4.7-transition-roadmap.md);
