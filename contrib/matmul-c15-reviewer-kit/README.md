...
> **Historical research kit.** This material remains useful for reproducing the
> named v4.4-LT non-collapse experiments, but it is not an activation checklist
> for MatMul v4.7. The canonical transition is Epoch A Profile-1 ExactReplay,
