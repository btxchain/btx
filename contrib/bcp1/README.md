...
**Release state.** This harness targets the **0.34.9-dev** tree (`CLIENT_VERSION_RC=0`, `CLIENT_VERSION_IS_RELEASE=false`); last shipping tag is **v0.34.8**. It is development tooling, not a listing attestation.
