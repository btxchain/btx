...
For MatMul v4.7 Epoch-A evidence, invoke the C++ harness with
``--base-production`` and a qualified full-device backend. Historical toy and
Profile-2 modes carry no consensus authority.
