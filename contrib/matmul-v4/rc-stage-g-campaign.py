...
"""Historical ENC_RC Stage G same-tip campaign driver (CPU-box honest path).

These profiles are not the MatMul v4.7 Epoch-A Profile-1 production campaign
and cannot authorize a proof or Profile-2 transition.
...
def aggregate_runs(
    ...
    campaign = {
        ...
        "consensus_note": (
            ...
            "Stage G campaign is PARTIAL/NO-GO: "
    ...
    for p in profiles:
        ...
        try:
            ...
            stub = {
                ...
                "consensus_note": (
                    "All MatMul v4.7 epoch heights remain disabled; "
                    "historical campaign error"
                ),
            }
