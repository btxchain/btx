#!/usr/bin/env bash
#
# Historical MatMul ENC_RC v4.6 hardware measurement.
#
# *** NOT THE MATMUL v4.7 EPOCH-A ACCEPTANCE ENTRYPOINT. ***
# Epoch A is Profile-1 ExactReplay; Profile 2 is deferred to proof-authoritative
# Epoch D. See doc/btx-matmul-v4.7-transition-roadmap.md.
...
if [ "$RC_MODE" -ne 1 ]; then
  ...
  echo "Retained ENC_RC v4.6 tooling; MatMul v4.7 Epoch A requires the Profile-1 ExactReplay campaign. Use one of:" >&2
