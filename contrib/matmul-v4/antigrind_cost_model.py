...
#
# HISTORICAL standalone COST MODEL (not a PoC, imports nothing from the tree)
# for the ENC_RC v4.6 profile-2 sampled-carrier anti-grind design spec.
# It is not MatMul v4.7 Epoch-A evidence: Profile 1 ExactReplay is authoritative
# there, and Profile 2 is deferred to proof-authoritative Epoch D.
