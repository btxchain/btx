...
"""ENC_RC golden-diff CI gate (historical Stage A1 / Stage H).

This guards retained construction vectors; it does not confer MatMul v4.7
authority or activate any epoch. The Profile-1 ExactReplay candidate needs its
separate dimension-bound cross-backend golden campaign.
