...
"""Historical ENC_RC Stage E verification bake-off launcher.

This toy proof bake-off is not MatMul v4.7 Epoch-A ExactReplay evidence and
does not authorize Epochs B-D.
