...
"""Historical ENC_RC measurement aggregator for rc-episode-harness reports.

This does not decide MatMul v4.7 activation or consensus authority. Epoch A
uses Profile-1 ExactReplay; sampled/Freivalds and Stage-3 evidence remains
non-authoritative. See doc/btx-matmul-v4.7-transition-roadmap.md.
...
def aggregate(reports: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    summary = {
        ...
        "consensus_note": (
            "All MatMul v4.7 epoch heights remain disabled. This historical "
...
def curve_only_summary(n_epochs: int) -> dict[str, Any]:
    ...
    return {
        ...
        "consensus_note": (
            "All MatMul v4.7 epoch heights remain disabled. §R.7 projected "
            "curve is PROVISIONAL / NOT EVIDENCE and must never "
