...
class CrlClient:
    def __init__(self, base_url: str,
        ...
        p=catalogue or Path(__file__).resolve().parents[1]/'schemas/operations-v1.2.json'
        self.operations={o['operation_id']:o for o in json.loads(p.read_text())['operations']}
