...
9. Live stress (post-fix rerun):
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --rounds 16 --initial-mine-blocks 140 --mine-every-rounds 2 --mine-batch-size 2 --max-runtime-seconds 900 --artifact /path/to/Documents/example/staging-repo/artifacts/live-load-stress-run4b.json`
   - Result: `pass`
   - Key counters:
     - `shield_success=23`
     - `unshield_success=2`
...
10. Full lifecycle matrix rerun:
   - `scripts/m15_full_lifecycle_matrix.sh --build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m15-full-matrix-run4b.json --log-dir /path/to/Documents/example/staging-repo/m15-full-matrix-logs-run4b`
...
11. Full runtime matrix rerun (`real-run-20260307-4`):
   - `python3 scripts/live_regtest_realworld_validation.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live-regtest-runtime.json --datadir /path/to/Documents/example/staging-repo/single-node-runtime/datadir --keep-datadir --mine-blocks 260 --mine-batch-size 10 --mining-rpc-timeout-seconds 180 --shielded-rpc-timeout-seconds 180`
   - `scripts/m12_dual_node_p2p_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/m12-dual-node.json --timeout-seconds 420`
   - `scripts/m13_mac_centos_interop_readiness.sh --mac-build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m13-mac-centos.json --timeout-seconds 420`
   - `scripts/m15_full_lifecycle_matrix.sh --build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m15-full-matrix.json --log-dir /path/to/Documents/example/staging-repo/logs/m15-full-lifecycle-logs --timeout-seconds 1500`
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live-load-stress.json --rounds 24 --initial-mine-blocks 160 --mine-every-rounds 2 --mine-batch-size 2 --max-runtime-seconds 1200 --shielded-rpc-timeout-seconds 180`
   - Result: all PASS
   - Key stress counters:
     - `rounds=24`
     - `shield_success=24`
...
12. Fast->normal ASERT transition replay (post-fix):
   - `scripts/m14_fast_normal_transition_sim.sh --build-dir build-btx-transition-sim --fast-mine-height 120 --normal-blocks 60 --artifact /path/to/Documents/example/staging-repo/artifacts/m14-fast-normal-transition.json --log-file /path/to/Documents/example/staging-repo/logs/m14-fast-normal-transition.log --backend cpu --max-wall-seconds 1200`
...
13. Run-cycle key safekeep snapshot:
   - `/path/to/Documents/example/staging-repo/keys/multisig-test-keys.json`
...
14. Full runtime matrix rerun (`real-run-20260307-5`):
   ...
   - `scripts/m12_dual_node_p2p_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/m12-dual-node.json --timeout-seconds 420`
   - `scripts/m13_mac_centos_interop_readiness.sh --mac-build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m13-mac-centos.json --timeout-seconds 420`
   - `scripts/m14_fast_normal_transition_sim.sh --build-dir build-btx-transition-sim --skip-build --fast-mine-height 160 --normal-blocks 40 --artifact /path/to/Documents/example/staging-repo/artifacts/m14-fast-normal-transition.json --log-file /path/to/Documents/example/staging-repo/logs/m14-fast-normal-transition.log --backend cpu`
   - `scripts/m15_full_lifecycle_matrix.sh --build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m15-full-lifecycle-matrix.json --log-dir /path/to/Documents/example/staging-repo/logs/m15-full-lifecycle-logs --timeout-seconds 1800`
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live-regtest-load-stress.json --rounds 30 --progress-every-rounds 5 --max-runtime-seconds 1800`
   - Result: all PASS
...
- Production readiness rerun:
  - `scripts/verify_btx_production_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/production-readiness-final.json --log-dir /path/to/Documents/example/staging-repo/logs/production-readiness-final --check-timeout-seconds 900`
  - Result: PASS
- Metal mining validation rerun:
  - `scripts/m11_metal_mining_validation.sh --build-dir build-btx --rounds 3 --artifact /path/to/Documents/example/staging-repo/artifacts/m11-metal-validation-final.json`
  - Result: PASS

### Run6 artifacts

- `/path/to/Documents/example/staging-repo/artifacts/production-readiness-final.json`
- `/path/to/Documents/example/staging-repo/artifacts/m11-metal-validation-final.json`
- `/path/to/Documents/example/staging-repo/artifacts/production-readiness-postfix.json`
- `/path/to/Documents/example/staging-repo/artifacts/m7-pool-e2e-postfix.json`
- `/path/to/Documents/example/staging-repo/artifacts/launch-blockers-postfix.json`
- `/path/to/Documents/example/staging-repo/artifacts/m9-benchmark-postfix.json`
...
1. Shielded functional subset rerun:
   - `build-btx/test/functional/test_runner.py wallet_shielded_send_flow.py wallet_shielded_cross_wallet.py wallet_shielded_reorg_recovery.py p2p_shielded_relay.py wallet_shielded_sendmany_stress.py --jobs=1 --tmpdirprefix=/path/to/Documents/example/staging-repo/single-node-runtime/functional-tmp`
   - Result: PASS (5/5, runtime 391s)

2. Production readiness consolidated run:
   - `scripts/verify_btx_production_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/production_readiness_20260308.json --log-dir /path/to/Documents/example/staging-repo/logs/production-readiness`
   - Result: PASS (`overall_status=pass`, `checks_total=17`, no failed checks)

3. Live single-node realworld runtime:
   - `python3 scripts/live_regtest_realworld_validation.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_realworld_validation_20260308.json --mine-blocks 180 --mine-batch-size 10 --datadir /path/to/Documents/example/staging-repo/single-node-runtime/live-realworld-datadir --keep-datadir`
...
4. Live load stress:
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_load_stress_20260308.json --rounds 20 --initial-mine-blocks 160 --mine-every-rounds 2 --mine-batch-size 2 --max-runtime-seconds 1200 --progress-every-rounds 1`
   - Result: PASS
   - Counters:
     - `rounds=20`
     - `shield_success=24`
...
5. M12 dual-node same-host relay:
   - `scripts/m12_dual_node_p2p_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/m12_dual_node_p2p_readiness_20260308.json`
   - Result: PASS
   - Evidence:
...
6. M13 macOS host <-> CentOS container interop:
   - `scripts/m13_mac_centos_interop_readiness.sh --mac-build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m13_mac_centos_interop_readiness_20260308.json`
   - Result: PASS
   - Evidence:
...
7. M14 fast->normal ASERT transition replay:
   - `scripts/m14_fast_normal_transition_sim.sh --build-dir build-btx-transition-sim --fast-mine-height 120 --normal-blocks 60 --artifact /path/to/Documents/example/staging-repo/artifacts/m14_fast_normal_transition_20260308.json --log-file /path/to/Documents/example/staging-repo/logs/m14_fast_normal_transition_20260308.log --backend cpu --max-wall-seconds 1200`
...
8. M15 full lifecycle matrix:
   - `scripts/m15_full_lifecycle_matrix.sh --build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m15_full_lifecycle_matrix_20260308.json --log-dir /path/to/Documents/example/staging-repo/logs/m15-full-lifecycle`
...
3. Production readiness rerun:
   - `scripts/verify_btx_production_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/production_readiness_20260308_run2.json --log-dir /path/to/Documents/example/staging-repo/logs/production-readiness`
   - Result: PASS (`overall_status=pass`, `checks_total=17`, `failed=[]`)

4. Live single-node runtime:
   - `python3 scripts/live_regtest_realworld_validation.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_realworld_validation_20260308_run2.json --mine-blocks 220 --mine-batch-size 10 --datadir /path/to/Documents/example/staging-repo/single-node-runtime/live-realworld-datadir --keep-datadir`
...
5. Live stress rerun:
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_load_stress_20260308_run2.json --rounds 24 --initial-mine-blocks 180 --mine-every-rounds 2 --mine-batch-size 2 --max-runtime-seconds 1500 --progress-every-rounds 2`
   - Result: PASS
   - Counters:
     - `rounds=24`
...
- `/path/to/Documents/example/staging-repo/keys/multisig-test-keys.json`
- `/path/to/Documents/example/staging-repo/artifacts/production_readiness_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/live_regtest_realworld_validation_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/live_regtest_load_stress_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/m12_dual_node_p2p_readiness_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/m13_mac_centos_interop_readiness_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/m14_fast_normal_transition_20260308_run2.json`
- `/path/to/Documents/example/staging-repo/artifacts/m15_full_lifecycle_matrix_20260308_run2.json`
...
1. Production readiness rerun:
   - `scripts/verify_btx_production_readiness.sh --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/production_readiness_20260308_run3.json --log-dir /path/to/Documents/example/staging-repo/logs/production-readiness`
   - Result: PASS (`overall_status=pass`, `checks_total=17`)

2. Live single-node runtime rerun:
   - `python3 scripts/live_regtest_realworld_validation.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_realworld_validation_20260308_run3.json --mine-blocks 260 --mine-batch-size 10 --datadir /path/to/Documents/example/staging-repo/single-node-runtime/live-realworld-datadir --keep-datadir`
   - Result: PASS (`overall_status=pass`)
   - Key evidence:
...
3. Live load stress rerun:
   - `python3 scripts/live_regtest_load_stress.py --build-dir build-btx --artifact /path/to/Documents/example/staging-repo/artifacts/live_regtest_load_stress_20260308_run3.json --rounds 32 --initial-mine-blocks 200 --mine-every-rounds 2 --mine-batch-size 2 --max-runtime-seconds 1800 --progress-every-rounds 2`
   - Result: PASS (`overall_status=pass`)
   - Counters:
     - `rounds=32`
     - `transparent_sent=19`
...
4. Host<->container interop rerun (macOS + CentOS):
   - `scripts/m13_mac_centos_interop_readiness.sh --mac-build-dir build-btx --centos-build-dir build-btx-centos --skip-centos-build --artifact /path/to/Documents/example/staging-repo/artifacts/m13_mac_centos_interop_readiness_20260308_run3.json`
   - Result: PASS (`overall_status=pass`)
   - Key evidence:
...
- `/path/to/Documents/example/staging-repo/artifacts/production_readiness_20260308_run3.json`
- `/path/to/Documents/example/staging-repo/artifacts/live_regtest_realworld_validation_20260308_run3.json`
- `/path/to/Documents/example/staging-repo/artifacts/live_regtest_load_stress_20260308_run3.json`
- `/path/to/Documents/example/staging-repo/artifacts/m13_mac_centos_interop_readiness_20260308_run3.json`
