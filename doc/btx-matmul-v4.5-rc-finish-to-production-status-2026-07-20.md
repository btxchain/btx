...
> **MatMul v4.7 use.** This dated checklist supplies proof-engineering evidence
> only. Epoch A activates neither GKR nor another succinct authority. Proofs are
> optional/shadow in Epoch A, mandatory alongside ExactReplay in Epoch B,
> authoritative for Profile 1 in Epoch C, and authoritative for Profile 2 only
> in Epoch D. Each transition requires a distinct disabled-until-reviewed
> height and the durable-proof gates in the canonical roadmap.
