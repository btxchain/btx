...
> **HISTORICAL v4.1 DISCUSSION.** This draft does not describe MatMul v4.7,
> its Profile-1 ExactReplay Epoch-A candidate, or the four-epoch proof/Profile-2
> transition. Its benchmark findings and shortcut concerns are retained as
> provenance only. See `doc/btx-matmul-v4.7-transition-roadmap.md`.
>
