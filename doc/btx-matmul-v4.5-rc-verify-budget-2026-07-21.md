...
> **MatMul v4.7 budget correction.** The historical 9-second CPU replay target
> below is not the Epoch-A acceptance rule. Epochs A and B permit qualified
> exact accelerator replay and require it for every claimed block. The current
> corrected M4 Max/Metal evidence is 28.199 s loaded p99, 28.333 s maximum, and
> 56.454 s for a zero-gap two-winner drain against a 90-second interval.
> Epoch C changes Profile-1 authority to the succinct proof; Epoch D separately
> changes the workload to Profile 2 under proof authority.
...
Source: private Lane-C campaign archive; committed artifacts are under
`doc/evidence/lane-c-2026-07-21/c2/`.
...
Source: `doc/evidence/lane-c-2026-07-21/c4/c4-stageg-kgate.json`
