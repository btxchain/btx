...
> **MatMul v4.7 transition status:** historical proof-development plan for
> possible Epochs B–D. It is not an Epoch-A launch plan and grants no
> authority. Epoch B requires a durable proof plus Profile-1 ExactReplay,
> Epoch C retains Profile 1 under proof authority, and Profile 2 is deferred to
