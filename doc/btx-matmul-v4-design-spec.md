...
**(c) Chained arithmetic (100 H100-eq ⇔ TOPS_net = 128,600 dTOPS, §Q.6; mint = 800 BTX/hr):**
- *8B central:* 128,600 dTOPS × 11.66 tok/s/dTOPS = 1.500×10⁶ tok/s (= 100 × 14,992 tok/s/H100) → × 3,600 s/hr = 5.397×10⁹ tok/hr → × $0.10×10⁻⁶/tok = $539.7/hr → × u=0.5 = **$269.9/hr** → ÷ 800 BTX/hr = **$0.34/BTX**.
- *70B central:* 128,600 × 1.63 = 2.090×10⁵ tok/s → × 3,600 = 7.524×10⁸ tok/hr → × $0.60×10⁻⁶ = $451.4/hr → × 0.5 = **$225.7/hr** → ÷ 800 = **$0.28/BTX**.
- *Rental basis, same fleet (§Q.6):* 100 × $2.50/hr = $250/hr → ÷ 800 = **$0.31/BTX**.
- *2,000 H100-eq (×20, linear in N_eq):* 8B **$6.75**, 70B **$5.64**/BTX (rental `P_prod` = $6.25).

**Sensitivity ($/BTX per 100 H100-eq, realistic basis; ×1.76 (8B) / ×1.46 (70B) for peak MFU; linear in H100-eq). Each cell = 100 × (tok/s/H100 × 3,600 × $/tok) × u / 800:**

| Reference × $/Mtok | u=0.25 | u=0.5 | u=1.0 |
|---|---:|---:|---:|
| 8B @ $0.08 | $0.13 | $0.27 | $0.54 |
| 8B @ $0.10 (central) | $0.17 | **$0.34** | $0.67 |
| 8B @ $0.18 | $0.30 | $0.61 | $1.21 |
| 70B @ $0.40 | $0.09 | $0.19 | $0.38 |
| 70B @ $0.60 (central) | $0.14 | **$0.28** | $0.56 |
| 70B @ $0.90 | $0.21 | $0.42 | $0.85 |
| *rental `P_prod` ref (r=$2.50, u-independent)* | *$0.31* | *$0.31* | *$0.31* |

(Sample verifications: 8B central u=0.5 → 100 × 14,992 × 3,600 × $0.10×10⁻⁶ × 0.5 / 800 = $0.337 ✓; 70B @ $0.90, u=1 → 100 × 2,090 × 3,600 × $0.90×10⁻⁶ / 800 = $0.847 ✓.)
...
|---|---|---|---|---|
| `P_prod` — cost-of-production **floor** (compute market, §Q.6 ≡ §S.4.3) | supply (lower) | ≈ **$0** (v3 = 0.32 TOPS junk-fleet compute → near-zero cost, §S.4.1) | **$0.31 per newly-minted coin at 100 H100-eq** (= 100×$2.50/800), ∝ `N_eq`; inference cross-check $0.28–0.34 (§Q.19) | **soft** lower anchor — the marginal miner's opportunity cost; tracks price both ways, *not* a hard support (§S.4.3, §0.7-(4)) |
