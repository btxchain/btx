...
> **MatMul v4.7 mapping.** The four-round episode dimensions
> (`b_seq=16,384`, 16 layers, four rounds, `T_leaf=1,024`) are the Profile-1
> workload used in Epochs A–C. The heavier Profile-2 workload is reserved for
> Epoch D under succinct-proof authority. Coupled-puzzle/V3 tables below are
> retained as historical construction data and are not an additional v4.7
> activation epoch.
