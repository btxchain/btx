...
> **MatMul v4.7 reuse boundary.** The byte-identity, self-qualification,
> truthful capability reporting, and fail-closed rules remain applicable to
> every accelerator. Profile-1 ExactReplay is the authority in Epochs A and B;
> proof authority begins only in Epoch C, and Profile 2 is deferred to Epoch D.
> An LT or coupled-puzzle qualification is not by itself a Profile-1
> ExactReplay qualification.
