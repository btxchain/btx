...
> **MatMul v4.7 reuse boundary.** This remains a dated backend snapshot. Its
> self-qualification and honest-provenance rules carry forward, but each
> backend must separately pass Profile-1 ExactReplay goldens and load tests for
> Epochs A/B. Proof authority is not permitted until Epoch C; Profile 2 is not
> selected until Epoch D.
