...
> **MatMul v4.7 use.** “v7” below names an internal proof construction, not
> MatMul v4.7. The bound is a candidate input to Epochs B–D and does not make
> the current proof authoritative. Epoch B requires a frozen, durable
> Profile-1 proof while ExactReplay still runs; Epoch C is the separate
> Profile-1 authority change; Epoch D separately binds Profile 2.
