...
> **MatMul v4.7 transition status:** historical proof analysis for possible
> Epochs B–D. It cannot authorize the Epoch-A Profile-1 ExactReplay path. A
> future mandatory proof must be durable, and Profile 2 activates only at
...
- **A-FS-INST** — permanent named residual; is a *disclosed assumption*, not a gap.
