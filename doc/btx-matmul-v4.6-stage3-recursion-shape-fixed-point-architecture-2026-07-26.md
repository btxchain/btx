...
> **MatMul v4.7 transition status:** historical proof-architecture analysis for
> possible Epochs B–D. It is unfinished, carries no authority, and does not
> alter the Profile-1 ExactReplay Epoch-A candidate. Mandatory proof data must
> be durable; Profile 2 is reserved for Epoch D. See
...
> a local isolated Stage-3 build, or COMPUTED from those two. Anything ASSUMED is
