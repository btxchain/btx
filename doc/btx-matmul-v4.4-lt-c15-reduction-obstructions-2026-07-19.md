...
*Date: 2026-07-19. Branch context: `feat/bmx4c-exact-accel-lanes`.*<br>
*Status: **NEGATIVE RESULTS / OBSTRUCTIONS** — informal but precise. Not a security proof.*<br>
...
- Game: `doc/btx-matmul-v4.4-lt-external-c15-packet.md` §0.1<br>
- Synthesis: `doc/btx-matmul-v4.4-lt-c15-prereview-synthesis-2026-07-19.md`<br>
- Combine / ASERT: `doc/btx-matmul-v4.4-combine-algorithm-tournament.md`<br>
- Prior-art map: `/tmp/c15_audit_prior_art.md`<br>
- KW paper: https://eprint.iacr.org/2025/685 — https://arxiv.org/abs/2504.09971<br>
