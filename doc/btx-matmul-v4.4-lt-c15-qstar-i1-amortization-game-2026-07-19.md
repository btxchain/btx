...
*Date: 2026-07-19. Branch: `feat/bmx4c-exact-accel-lanes`.*<br>
*Wave 3 Gap #9 deliverable. Sources: crypto survey §3 (BRSV as vocabulary
only); packet §§0.1, 3, 5; fold rank **9**; shortcut/TMTO S9/S10; GAP-D8.*<br>
***Do not claim C-15 cryptographically closed. Do not raise `nMatMulDRLTHeight`.***<br>
