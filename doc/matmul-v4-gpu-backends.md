...
> activated epochs. Mainnet Epoch A (v4 = BMX4C = RC) now activates at height 182'600; all other transition heights remain disabled. See
> [`btx-matmul-v4.7-transition-roadmap.md`](btx-matmul-v4.7-transition-roadmap.md)
> and [`benchmarking.md`](benchmarking.md).

# MatMul v4 GPU Backends — Build & Hardware-Verification Runbook

**Status:** normative only for the legacy backend path described below. It
does not by itself qualify a Profile 1 ExactReplay backend or authorize
mainnet activation. This runbook is the operational
...
replay result cannot substitute for Profile 1 launch evidence.
