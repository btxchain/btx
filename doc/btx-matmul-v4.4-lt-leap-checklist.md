...
| 3 | Persistent device-resident GPU | LT CUDA: persistent buffers; **s8xs8 IMMA via cuBLASLt** (`TryLaunchLtImmaGemmS8S8Device`) when self-qual; s32xs8 scalar; scalar graphs on decline. HIP: hipBLASLt/rocBLAS MFMA when linked+self-qual else honest ALU (never labeled MFMA). Chat still D2H | Device SHA256d + B200/5090/MI350 perf proof |
| 4 | FP4/FP8/Tensor genuinely wired | Portable exact MXFP4; CUTLASS/device FP8 **fail-closed**; cuBLASLt MXFP4 no-algo on sm_100/sm_120 (PR #89); hand PTX sm_120a ≠ sm_100a | sm_100a / MI350 M-t24 qualified |
