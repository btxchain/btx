...
> **MatMul v4.7 transition status:** historical target selection for unfinished
> proof machinery. “V1” here is a proof-format label, not Profile 1 and not a
> network epoch. It does not authorize Epoch A. Epochs B–D require a durable,
> audited proof and separate activation heights; Profile 2 is Epoch D only.
> See `doc/btx-matmul-v4.7-transition-roadmap.md`.
>
**Decision date:** 2026-07-27<br>
