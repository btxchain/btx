...
> B–D. It has no authority in Epoch A. Epoch B requires a durable mandatory
> proof **and** Profile-1 ExactReplay; Epoch C may make that proof authoritative
> while retaining Profile 1; only Epoch D may select Profile 2. See
