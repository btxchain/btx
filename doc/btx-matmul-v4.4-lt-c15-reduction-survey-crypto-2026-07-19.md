...
*Wave 1 — SURVEY (crypto / PoW-theory lens).*<br>
*Scope: named assumptions closest to LT-C15 MatExpand Extract; map formal sketches → BTX applicability → obstructions → residual useful lemmas.*<br>
*Sources: `doc/btx-matmul-v4.4-lt-external-c15-packet.md`, `/tmp/c15_audit_prior_art.md`, `/tmp/c15_audit_shortcut_tmto.md`, `contrib/matmul-c15-reviewer-kit/README.md`, companions in prior-art citation list.*<br>
