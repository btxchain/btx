...
node path on a real block from `/home/administrator/rcepisode-chain` (RPC 19335,
...
failure, `BTX_GPU_ROWLEAF_AUDIT=1` for parity). macpro2, sm_120, CUDA 13.3.
...
**4.6 Main-repo port.** `/home/administrator/Documents/btxchain/btx` is
...
- `sshd` binds **only** to the Tailscale address `100.106.51.32:2022`. If the tailnet
