...
Current v0.32.4 production behavior: after block `125000`, consensus disables
...
lattice-based zero-knowledge proofs. As of v0.32.4, coinbase auto-shielding is
...
As of v0.32.4, current production nodes enforce the block-`125000` sunset:
new shielded credits, private shielded-output appends, bridge ingress/control
