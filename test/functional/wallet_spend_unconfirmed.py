...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    def test_unconfirmed_cluster_limit_error(self):
        ...
        # Confirm leftovers from previous test cases so this scenario starts from an empty mempool.
        ...
        # BTX's transparent-to-PQ sweep is another fee-aware AvailableCoins caller.
        assert_raises_rpc_error(
            -4,
            error_msg,
            wallet.sweeptoself,
            {"fee_rate": 10, "preferred_pq_algo": "slh_dsa_128s"},
        )
