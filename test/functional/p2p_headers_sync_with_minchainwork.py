...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ["-minimumchainwork=0x0", "-checkblockindex=0", *matmul_transition_off],
            ["-minimumchainwork=0x1f", "-checkblockindex=0", *matmul_transition_off],
            ["-minimumchainwork=0x1000", "-checkblockindex=0", *matmul_transition_off],
            ["-minimumchainwork=0x1000", "-checkblockindex=0", "-whitelist=noban@127.0.0.1", *matmul_transition_off],
        ]
