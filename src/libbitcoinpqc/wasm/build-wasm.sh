...
#   dist/btx-pqc.mjs   same ES module loader, with a Node-friendly extension
...
cp "${OUT_DIR}/btx-pqc.js" "${OUT_DIR}/btx-pqc.mjs"

rm -rf "${OBJ_DIR}"

echo
echo "Artifacts:"
ls -la "${OUT_DIR}/btx-pqc.js" "${OUT_DIR}/btx-pqc.mjs" "${OUT_DIR}/btx-pqc.wasm"
echo
echo "SHA-256:"
if command -v sha256sum >/dev/null 2>&1; then
    sha256sum "${OUT_DIR}/btx-pqc.js" "${OUT_DIR}/btx-pqc.mjs" "${OUT_DIR}/btx-pqc.wasm"
else
    shasum -a 256 "${OUT_DIR}/btx-pqc.js" "${OUT_DIR}/btx-pqc.mjs" "${OUT_DIR}/btx-pqc.wasm"
fi
