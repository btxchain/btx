...
// Classical secp256k1/ECDSA release signatures are not accepted.
...
// channel (which can ship code to every node) must itself be quantum-safe.
// Supported values: "ml-dsa-44", "slh-dsa-128s". secp256k1 is not a valid scheme.
...
// Build a verifier for the named release-signature scheme ("ml-dsa-44" or
// "slh-dsa-128s"). Returns nullptr for an unknown or classical scheme.
