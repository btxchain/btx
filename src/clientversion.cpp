 ...
 * for both bitcoind and btx-qt, to make it harder for attackers to
...
// Git-backed builds also include the full revision and dirty state used by
// production-evidence tools to bind an artifact to its compiled source.
