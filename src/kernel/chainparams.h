...
public:
    ...
    struct RegTestOptions {
        ...
        std::optional<int32_t> shielded_pool_disable_height{};
        ...
        //! Legacy PR89 single-switch regression control. When set, assigns the SAME
        ...
        //! regime). MatMul v4.7 does not use this as its public activation model.
        //! Applied before the granular per-component overrides so a test
