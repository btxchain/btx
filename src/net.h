 ...
 *  < 16,000,000 bytes in matmul_v4_rc_freivalds_sampled.h) plus small framing
 *  (32-byte block hash + compactSize). Rides in ONE piece under BOTH the v2
 *  (BIP324) ~16 MB packet ceiling AND the v1 MAX_PROTOCOL_MESSAGE_LENGTH
 *  (16 MB). The
...
static const unsigned int MAX_RCCARRIER_PAYLOAD_SIZE = 15'990'000u + 64u;
