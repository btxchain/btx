...
> **MatMul v4.7 scope.** This provider remains an optional exact accelerator
> boundary. Epoch A consensus is Profile 1 ExactReplay; no Trainium result may
> grant proof authority or silently select Profile 2. See the
