...
BOOST_AUTO_TEST_CASE(ChainParams_MAIN_matmul_activation)
{
    ...
    BOOST_CHECK_EQUAL(consensus.nMatMulAsertHalfLifeUpgradeHeight, 200'001);
    BOOST_CHECK_EQUAL(consensus.nMatMulAsertHalfLifeUpgrade, 14'400);
    BOOST_CHECK_EQUAL(consensus.nMatMulPowLimitUpgradeHeight, 200'000);
    ...
    BOOST_CHECK(MatMulAsertPowLimitForNextHeight(consensus, 199'999) == UintToArith256(consensus.powLimit));
    BOOST_CHECK(MatMulAsertPowLimitForNextHeight(consensus, 200'000) == UintToArith256(consensus.powLimitUpgrade));
    BOOST_CHECK(MatMulAsertPowLimitForNextHeight(consensus, 200'001) == UintToArith256(consensus.powLimitUpgrade));
