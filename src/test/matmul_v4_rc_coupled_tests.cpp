...
{
    // Legacy PR89 regression switch: -regtestrcunifiedheight=N sets BOTH the ENC_RC episode
    ...
    // MatMul v4.7 regtest activates only Profile 1 RC at height 101 by default.
    // The unfinished coupled/proof path remains an explicit regression opt-in,
    // while public networks remain fail-closed.
