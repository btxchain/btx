...
BOOST_AUTO_TEST_CASE(gkr_h2_shadow_reuses_prior_exact_replay)
{
    ...
    p.nMatMulV4Height = 1;
    p.nMatMulRCHeight = 1;
    // Select profile 1 explicitly to keep this shadow-reuse fixture on its
    // original epoch-0 dimensions. Both profiles use ExactReplay authority
    // while the durable Stage-3 authority remains disabled.
