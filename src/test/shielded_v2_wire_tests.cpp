...
BOOST_AUTO_TEST_CASE(family_id_inventory_is_stable)
{
    ...
    BOOST_CHECK_EQUAL(static_cast<uint8_t>(TransactionFamily::V2_SPEND_PATH_RECOVERY), 8);
    BOOST_CHECK_EQUAL(V2_SPEND_PATH_RECOVERY, TransactionFamily::V2_SPEND_PATH_RECOVERY);
    ...
    BOOST_CHECK_EQUAL(GetTransactionFamilyName(TransactionFamily::V2_SPEND_PATH_RECOVERY), "v2_spend_path_recovery");
    BOOST_CHECK(IsValidTransactionFamily(TransactionFamily::V2_SPEND_PATH_RECOVERY));
}
