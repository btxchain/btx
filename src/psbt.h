...
bool PSBTInputSignedAndVerified(const PartiallySignedTransaction& psbt, unsigned int input_index, const PrecomputedTransactionData* txdata, bool slhdsa_fips205 = false);
 ...
 **/
bool SignPSBTInput(const SigningProvider& provider, PartiallySignedTransaction& psbt, int index, const PrecomputedTransactionData* txdata, int sighash = SIGHASH_ALL, SignatureData* out_sigdata = nullptr, bool finalize = true, bool slhdsa_fips205 = false);
 ...
 */
bool FinalizePSBT(PartiallySignedTransaction& psbtx, bool slhdsa_fips205 = false);
 ...
 */
bool FinalizeAndExtractPSBT(PartiallySignedTransaction& psbtx, CMutableTransaction& result, bool slhdsa_fips205 = false);
