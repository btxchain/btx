...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-regtestrcheight=<n>", "Override regtest MatMul ENC_RC (Resident Curriculum) activation height; must be >= the (possibly also-overridden) MatMul v4 height (regtest-only; public-net heights are fixed in chainparams: mainnet 182600, testnet/signet disabled)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
