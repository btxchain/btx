...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-regtestrccoupledtoydims=<0|1>", "Use CI-scale toy ENC_RC_COUPLED dims on regtest when the coupled profile is live (1) instead of medium dims (0); required for practical mining when -regtestrccoupledheight is finite (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
