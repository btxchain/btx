...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-regtestrccoupledprofile=<2|3>", "Select ENC_RC_COUPLED consensus shape family on regtest: 2=V2 (default), 3=V3. Invalid values fail closed (ResolveRCCoupParams → zero params / reject). Pair with -regtestrccoupledtoydims (regtest-only; public nets stay profile 2)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
