...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-regtestmatmulltsealaspow", "Enable the MatMul v4.4-LT Q* Phase B seal-as-PoW window lottery object (regtest-only; requires a live -regtestdrltheight)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
