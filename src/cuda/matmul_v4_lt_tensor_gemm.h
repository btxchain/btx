 ...
 *  This is device identity, not an execution claim: Metal 4 MPP INT8 has
 *  compiled and self-qualified on M4-class hosts, while M5Class records an
 *  actual M5 device name. ProbeLtMetalExactGemmCapabilities reports the
 *  runtime MPP-vs-ALU capability separately. */
