...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-reorgprotectionprofile=<mode>", "Per-node reorg/finality profile: emergency (default), standard, miner (alias for standard), archive, balanced, or strict. emergency/strict warn after 3-block rewrites and park after 12; standard/miner warn after 3 and follow most work unless -parkdeepreorg=1; archive follows most work and only alarms after 72; balanced warns after 12 and parks after 48. This is local finality/fork-choice policy, not block validity.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    argsman.AddArg("-maxreorgdepthpark=<n>", "Park/refuse automatic switch when a candidate branch would reorganize more than this many blocks and -parkdeepreorg=1 (default: active -reorgprotectionprofile park depth, standard=12 when parking is explicitly enabled). Must be >= 1.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-localfinalitydepth=<n>", "Report practical local finality after this many confirmations in mining/difficulty RPCs (default: active -reorgprotectionprofile finality depth, standard=12). This is not consensus finality. Must be >= 1.", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
