    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your BTX P2MR addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->newAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your BTX P2MR addresses for receiving payments. Use the 'Request payment' button in the receive tab to create new addresses. BTX does not issue legacy, bech32, or taproot addresses."));
