...
{
    // Validation callbacks run on the scheduler thread. Marshal model updates
    // to the GUI thread and do not capture this interface, which may be gone
    // before the queued callback is delivered.
