...
/**
  BTX GUI main class. This class represents the main window of the BTX UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a BTX wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BTX Transaction (PSBT) from file or clipboard */
