...
//
//   * usually #if-guarded by the backend's CMake define -- when a backend is compiled in
...
//     Ascend currently implements only the LT/RC entry points, so its generic
//     v4/BMX4C stubs remain linked in all configurations;
//
