...
// --- End-to-end RC fused FFN (Metal MPP GEMM + GPU ExtractMX) ---
[[nodiscard]] bool IsRcExactReplayFusedMetalQualified();
[[nodiscard]] bool SelfQualifyRcExactReplayFusedMetalOnce();
